...
void setupTestUI(Router& router)
{
    ...
    ButtonWidget* button3 = new ButtonWidget({0, 1, 20, 1}, btn1Label, defaultButtonStyle,
                                             [](){ Serial.println("Button 1 pressed"); });

    static StaticText btn2Text("Button 2");
    LabelWidget* btn2Label = new LabelWidget({0, 0, 18, 1}, btn2Text);
    ButtonWidget* button4 = new ButtonWidget({0, 2, 20, 1}, btn2Label, defaultButtonStyle,
    ...
    ButtonWidget* button5 = new ButtonWidget({0, 1, 20, 1}, btn3Label, defaultButtonStyle,
                                             [](){ Serial.println("Button 3 pressed"); });

    static StaticText btn4Text("Button 4");
    LabelWidget* btn4Label = new LabelWidget({0, 0, 18, 1}, btn4Text);
    ButtonWidget* button6 = new ButtonWidget({0, 2, 20, 1}, btn4Label, defaultButtonStyle,
    ...
    LabelWidget* label1 = new LabelWidget({0, 0, 20, 1}, homeText);

    static StaticText submenu1BtnText("Submenu 1");
    LabelWidget* sub1Label = new LabelWidget({0, 0, 18, 1}, submenu1BtnText);
    ButtonWidget* button1 = new ButtonWidget({0, 1, 20, 1}, sub1Label, defaultButtonStyle,
                                             nullptr,
    ...
    ButtonWidget* button2 = new ButtonWidget({0, 2, 20, 1}, sub2Label, defaultButtonStyle,
                                             nullptr,
